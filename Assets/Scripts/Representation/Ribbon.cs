...
public class Ribbon : MonoBehaviour {
    ...
    public void DrawRibbon(string DSSPfile)
    {
        ...
        DSSPfile = GameObject.Find("Manager").GetComponent<HttpTest>().outputfile;
        ...
        ThisFile.name = string.Format("File {0}", GameObject.Find("Manager").GetComponent<Load>().FileNumber);
        ...
        ThisPDB.name = string.Format("PDB{0}", GameObject.Find("Manager").GetComponent<Load>().FileNumber);
        ...
        for (int tem = 0; tem < totmolnum; tem++)
        {
            ...
            Protein.name = string.Format("PDB.{0}.molecule.{1}", GameObject.Find("Manager").GetComponent<Load>().FileNumber, tem);

            // some sanity checks
            if (GameObject.Find(string.Format("PDB.{0}.molecule.{1}", GameObject.Find("Manager").GetComponent<Load>().FileNumber, tem)) == null) { ConsoleText.text += string.Format("\n Molecule {0} GameObject does not exist.", tem); }
		...
		*/
        ...
        ConsoleText.text += string.Format("\n Cartoon structure drawn for PDB #{0}.", GameObject.Find("Manager").GetComponent<Load>().FileNumber);
        ...
        GameObject.Find("Manager").GetComponent<Load>().FileNumber++;
    ...
    Color Colors(string structure)
    {
        ...
        {
            case "H":
                return Manager.GetComponent<Colors>().Purple;
            case "B":
                return Manager.GetComponent<Colors>().Yellow;
            case "E":
                return Manager.GetComponent<Colors>().Yellow;
            case "G":
                return Manager.GetComponent<Colors>().Purple;
            case "I":
                return Manager.GetComponent<Colors>().Purple;
            case "T":
                return Manager.GetComponent<Colors>().Aquamarine;
            case "S":
                return Manager.GetComponent<Colors>().Aquamarine;
            default:
                return Color.white;
